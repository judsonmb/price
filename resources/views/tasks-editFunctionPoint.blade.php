        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    Faça uma análise mais profunda do tarefa <br>
                    <strong>{{ $task->name }}</strong><br>
                    <textarea readonly class="form-control" rows="5" id="custom-toolbar-menu-button">{{ $task->description }}</textarea>
                </div>
                <div class="card-body">
                        <form method="POST" action="{{ route('tasks.updateFunctionPoint', $task->id) }}">
                            @csrf
                            @method('PUT')
                            <div class="form-group">
                                <label>Será feita alguma modificação no banco de dados? (0 para não)<br>
                                Se sim, quantos campos de banco de dados serão criados com este tarefa?</label>
                                ...
                                <input type="number" class="form-control" name="ali_data_type_amount" value="{{ $task->ali_data_type_amount }}">
                            </div>
                            <div class="form-group">
                                <label>Será feita alguma modificação no banco de dados? (0 para não)<br>
                                ...
                                <input type="number" class="form-control" name="ali_register_type_amount" value="{{ $task->ali_register_type_amount }}">
                            </div>
                            <div class="form-group">
                                <small class="form-text text-muted">Justifique os valores inseridos.</small>
                                <input type="text" class="form-control @error('ali_justify') is-invalid @enderror" name="ali_justify" value="{{ $task->ali_justify }}">
                            ...
                            <div class="form-group">
                                ...
                                Se sim, quantos campos de banco de dados de outra aplicação serão criados com este tarefa?</label>
                                ...
                                <input type="number" class="form-control" name="aie_data_type_amount" value="{{ $task->aie_data_type_amount }}">
                            </div>
                            <div class="form-group">
                                <label>Será feita alguma modificação no banco de dados? (0 para não)<br>
                                Se sim, quantas tabelas diferentes serão modificadas?</label>
                                ...
                                <input type="number" class="form-control" name="aie_register_type_amount" value="{{ $task->aie_register_type_amount }}">
                            </div>
                            <div class="form-group">
                                <small class="form-text text-muted">Justifique os valores inseridos.</small>
                                <input type="text" class="form-control @error('aie_justify') is-invalid @enderror" name="aie_justify" value="{{ $task->aie_justify }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="ee_data_type_amount" value="{{ $task->ee_data_type_amount }}"> 
                            </div>
                            <div class="form-group">
                                <label>O usuário final vai modificar (cadastrar/editar/excluir) alguma coisa? (0 para não)<br>
                                ...
                                <input type="number" class="form-control" name="ee_referenced_files_amount" value="{{ $task->ee_referenced_files_amount }}"> 
                            </div>
                            <div class="form-group">
                                <small class="form-text text-muted">Justifique os valores inseridos.</small>
                                <input type="text" class="form-control @error('ee_justify') is-invalid @enderror" name="ee_justify" value="{{ $task->ee_justify }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="se_data_type_amount" value="{{ $task->se_data_type_amount }}">
                            </div>
                            <div class="form-group">
                                <label>O sistema vai consultar e processar algo do banco de dados e mostrar para o usuário? (0 para não)<br>
                                Se sim, quantas tabelas diferentes serão consultadas?</label>
                                <small class="form-text text-muted">Não considerar mais de um quando envolve o mesmo conceito. Tabelas Pessoas e Instituições contam como 2, mas Processos e Histórico de Processos só contam como 1.</small>
                                <input type="number" class="form-control" name="se_referenced_files_amount" value="{{ $task->se_referenced_files_amount }}"> 
                            </div>
                            <div class="form-group">
                                <small class="form-text text-muted">Justifique os valores inseridos.</small>
                                <input type="text" class="form-control @error('se_justify') is-invalid @enderror" name="se_justify" value="{{ $task->se_justify }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="ce_data_type_amount" value="{{ $task->ce_data_type_amount }}">
                            </div>
                            <div class="form-group">
                                <label>O sistema somente consulta e mostra algo do banco de dados para o usuário? (0 para não)<br>
                                Se sim, quantas tabelas diferentes serão consultadas?</label>
                                <small class="form-text text-muted">Não considerar mais de um quando envolve o mesmo conceito. Tabelas Pessoas e Instituições contam como 2, mas Processos e Histórico de Processos só contam como 1.</small>
                                <input type="number" class="form-control" name="ce_referenced_files_amount" value="{{ $task->ce_referenced_files_amount }}"> 
                            </div>
                            <div class="form-group">
                                <small class="form-text text-muted">Justifique os valores inseridos.</small>
                                <input type="text" class="form-control @error('ce_justify') is-invalid @enderror" name="ce_justify" value="{{ $task->ce_justify }}">
